...
<body>
                        ...
                        <form action="" method="POST">
                            <div class="form-group">
                                ...
                                <input type="text" name="e_name" class="form-control" id="exampleInputEmail1"
                                    aria-describedby="emailHelp" value="<?php echo $employee['name'];?>">
                            </div>
                            <div class="form-group">
                            ...
                            <p></p>
                            <button type="submit" name="e_edit" class="btn btn-warning">Edit Employee</button>
                        </form>
                    </div>
                </div>
            </div>
    ...
    if(isset($_POST['e_edit'])){
        ...
        $sql="UPDATE employees SET name='$e_name',position='$e_pos',phone='$e_phone' WHERE id='$id'";
